...
export function useShareActions(
  ...
  const handleCopyLink = async (): Promise<boolean> => {
    ...
    try {
      ...
      console.error('[useShareActions] handleCopyLink failed:', err);
  ...
  const handleDownloadPNG = async () => {
    ...
    try {
      ...
      console.error('[useShareActions] handleDownloadPNG failed:', err);
  ...
  const handleDownloadWEBP = async () => {
    ...
    try {
      ...
      console.error('[useShareActions] handleDownloadWEBP failed:', err);
  ...
  const handleCopyImage = async () => {
    ...
    try {
      ...
      console.error('[useShareActions] handleCopyImage failed:', err);
  ...
  const handleDownloadSVG = async () => {
    ...
    try {
      ...
      console.error('[useShareActions] handleDownloadSVG failed:', err);
  ...
  const handleCopyMarkdown = async () => {
    ...
    try {
      ...
      console.error('[useShareActions] handleCopyMarkdown failed:', err);
  ...
  const handleDownloadCSV = () => {
    ...
    try {
      ...
      console.error('[useShareActions] handleDownloadCSV failed:', err);
  ...
  const handleDownloadJSON = () => {
    ...
    try {
      ...
      console.error('[useShareActions] handleDownloadJSON failed:', err);
